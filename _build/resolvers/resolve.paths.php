...
function createSetting(&$modx,$key,$value) {
    ...
    if (empty($ct)) {
        ...
        $setting->set('key','rowboat.'.$key);
        $setting->set('value',$value);
        $setting->set('namespace','rowboat');
...
if ($object->xpdo) {
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            /* setup paths */
            createSetting($modx,'core_path',$modx->getOption('core_path').'components/rowboat/');
            createSetting($modx,'assets_path',$modx->getOption('assets_path').'components/rowboat/');

            /* setup urls */
            createSetting($modx,'assets_url',$modx->getOption('assets_url').'components/rowboat/');
        break;
    }
}
return true;